...
app.config["MONGO_URI"] = \
    "mongodb://172.18.0.35:27017/DBfelipeborges"
mongo = PyMongo(app)

#listClients =[
#    Client(name="Zezinho", email="zezinho@univille.br", phone="5551234"),
#    Client(name="Luizinho", email="luizinho@univille.br", phone="5555432"),
#    Client(name="Huguinho", email="huguinho@univille.br", phone="5556666"),
#]
